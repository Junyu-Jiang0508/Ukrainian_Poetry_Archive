...
INPUT_CSV = Path("outputs/01_pronouns_detection/ukrainian_pronouns_projection_final.csv")
...
def main():
    ...
    print("\nSaved: pronoun_timeseries_adaptive.csv, adaptive_intervals.csv, adaptive_intervals.png")
