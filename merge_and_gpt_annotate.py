...
DATA_DIR = "data"
OUTPUT_DIR = os.path.join("outputs", "01_pronouns_detection")
FILE_JUNYU = os.path.join(DATA_DIR, "manual_annotation_result_Junyu.csv")
FILE_JUNYU1 = os.path.join(DATA_DIR, "manual_annotation_result_junyu1.csv")
GPT_DETAILED = os.path.join(OUTPUT_DIR, "gpt_annotation_detailed.csv")
MERGED_WITH_GPT = os.path.join(DATA_DIR, "manual_annotation_merged_with_gpt.csv")
OUTPUT_MERGED = os.path.join(DATA_DIR, "manual_annotation_merged.csv")
