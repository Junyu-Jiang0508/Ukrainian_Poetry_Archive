...
df = pd.read_csv("outputs/01_pronouns_detection/ukrainian_pronouns_detailed.csv", encoding="utf-8")
...
output_path = "outputs/01_pronouns_detection/ukrainian_pronouns_annotated_50.csv"
