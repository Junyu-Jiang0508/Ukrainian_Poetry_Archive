...
merged = pd.read_csv("data/manual_annotation_merged.csv")
gpt_raw = pd.read_csv("outputs/01_pronouns_detection/gpt_annotation_detailed.csv")
...
vc.to_csv("outputs/01_pronouns_detection/unmatched_pronoun_dist.csv", encoding="utf-8-sig")
unmatched.head(20).to_csv(
    "outputs/01_pronouns_detection/unmatched_sample.csv", index=False, encoding="utf-8-sig"
)
print("wrote outputs/01_pronouns_detection/unmatched_sample.csv")
