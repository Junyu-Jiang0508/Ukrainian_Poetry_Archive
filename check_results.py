...
# Check progress
with open('outputs/01_pronouns_detection/lmstudio_progress.json', 'r', encoding='utf-8') as f:
...
print("=" * 60)
try:
    df = pd.read_csv('outputs/01_pronouns_detection/ukrainian_pronouns_detailed.csv')
