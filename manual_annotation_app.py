...
# Column order must match gpt_annotation_test_result.csv
OUTPUT_COLUMNS = [
...
SENTENCE_FILE = r"outputs\01_pronouns_detection\poems_for_manual_annotation.csv"
OUTPUT_FILE = r"outputs\01_pronouns_detection\manual_annotation_result.csv"
PROGRESS_FILE = r"outputs\01_pronouns_detection\manual_annotation_progress.json"
POEM_PERSPECTIVE_FILE = r"outputs\01_pronouns_detection\manual_annotation_poem_perspectives.json"
POEM_PERSPECTIVE_CSV = r"outputs\01_pronouns_detection\manual_annotation_poem_perspectives.csv"
