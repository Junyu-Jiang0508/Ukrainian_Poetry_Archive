...
PRONOUN_DETAILED = os.path.join(ROOT, "outputs", "01_pronouns_detection", "ukrainian_pronouns_detailed.csv")
PRONOUN_PROJECTION = os.path.join(ROOT, "outputs", "01_pronouns_detection", "ukrainian_pronouns_projection_final.csv")
GPT_DETAILED = os.path.join(ROOT, "outputs", "01_pronouns_detection", "gpt_annotation_detailed.csv")
