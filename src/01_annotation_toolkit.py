...
def main():
    pronoun_file = "./outputs/01_annotation_pronoun_detection/ukrainian_pronouns_detailed.csv"
    ...
    output_file = "./outputs/01_annotation_toolkit/annotation_sample.csv"
    Path("./outputs/01_annotation_toolkit").mkdir(exist_ok=True, parents=True)
