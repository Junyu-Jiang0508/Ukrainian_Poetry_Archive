...
with open('outputs/01_annotation_pronoun_detection/lmstudio_progress.json', 'r', encoding='utf-8') as f:
...
print("=" * 60)
try:
    df = pd.read_csv('outputs/01_annotation_pronoun_detection/ukrainian_pronouns_detailed.csv')
