...
DEFAULT_OUTPUT_DIR = stage_output_dir("02_modeling_pronoun_semantic_space", root=ROOT)
DEFAULT_DATE_INPUT = ROOT / "outputs" / "02_modeling_pronoun_cooccurrence" / "pronoun_cooccurrence_with_date.csv"
DEFAULT_SIMPLE_INPUT = ROOT / "outputs" / "02_modeling_pronoun_cooccurrence" / "pronoun_cooccurrence.csv"
