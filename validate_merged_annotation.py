"""Validate manual vs GPT on data/manual_annotation_merged_with_gpt.csv."""
import os
import pandas as pd
from sklearn.metrics import precision_recall_fscore_support

MERGED_FILE = os.path.join("data", "manual_annotation_merged_with_gpt.csv")
METRICS_OUTPUT = os.path.join("outputs", "01_pronouns_detection", "validation_merged_metrics.csv")
ERROR_OUTPUT = os.path.join("outputs", "01_pronouns_detection", "validation_merged_errors.csv")
