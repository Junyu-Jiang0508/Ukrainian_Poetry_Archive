...
INPUT_FILE = r"outputs\01_pronouns_detection\ukrainian_pronouns_projection_final.csv"
OUTPUT_FILE = r"outputs\01_pronouns_detection\poems_for_manual_annotation.csv"
